  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-24">
      ...
      <div className="mt-12 flex flex-col gap-6 sm:flex-row sm:items-start">
        ...
        {/* PLACEHOLDER: foto real de Mario Díaz en vez del bloque de color */}
        <div>
          <h2 className="font-display text-2xl font-semibold text-ink">
            Mario Díaz
          </h2>
          {/* PLACEHOLDER: cargo exacto — Secretario General u otro */}
          <p className="text-sm font-medium uppercase tracking-wide text-amber">
            Secretario General
          </p>
          {/* PLACEHOLDER: bio real */}
      ...
      <div className="mt-20">
        ...
        {/* PLACEHOLDER: roles y nombres reales */}
